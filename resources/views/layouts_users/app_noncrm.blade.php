        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> Manager Non-CRM</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{asset('dashboard_noncrm')}}"><i class="fa fa-circle-o"></i> Home</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="{{asset('noncrm_customer')}}"><i class="fa fa-circle-o"></i> Laporan Customer</a></li>
              <li class="active"><a href="{{asset('noncrm_kontrak')}}"><i class="fa fa-circle-o"></i> Laporan Kontrak</a></li>
              <li class="active"><a href="{{asset('noncrm_mou')}}"><i class="fa fa-circle-o"></i> Laporan Data MOU</a></li>
            </ul>
        </li>
